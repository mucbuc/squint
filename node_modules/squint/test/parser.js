...
function functionParameters() {
  var parser = new TestParser( { 
      '(': 'open parameter', ')': 'close parameter', 
      '<': 'open parameter', '>': 'close parameter' 
    } );
  
  parser.expect( 'open parameter', 'a b' );
  parser.process( 'a b(' );

  parser.expect( 'open parameter', 'a b' );
  parser.expect( 'close parameter', 'abc' );
  ...
  parser.expect( 'open parameter', 'a b' );
  parser.expect( 'close parameter', 'abc, cd' );
  parser.expect( 'open parameter', 'bla bla' );
  parser.expect( 'close parameter', 'xyz, zyx' );
